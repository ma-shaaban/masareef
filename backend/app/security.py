...
# limit, and concurrent signups at 64 MiB each can OOM the pod. The semaphore
# bounds worst-case concurrent hashing memory regardless of threadpool width;
# params ride inside each stored hash, so existing hashes keep verifying.
...
_MAX_TRACKED_KEYS = 50_000  # hard memory bound; clearing resets limits
